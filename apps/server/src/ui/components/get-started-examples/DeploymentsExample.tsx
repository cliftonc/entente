...
function DeploymentsExample() {
  const deploymentCode = `entente deploy-service -n my-service --service-version 1.0.0 -e production -t provider
entente deploy-service -n my-consumer --service-version 2.0.3 -e production -t consumer`
