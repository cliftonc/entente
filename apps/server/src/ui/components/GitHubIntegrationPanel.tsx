      ...
      <div className="card bg-base-100 shadow-xl">
        <div className="card-body">
          ...
          <div className="text-center py-4">
            <svg className="w-12 h-12 mx-auto mb-3 text-base-content/40" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="card bg-base-100 shadow-xl">
        <div className="card-body">
          ...
          <div className="text-center py-6">
            ...
            <div className="text-sm font-medium text-base-content mb-2">No Repository Configured</div>
            ...
            <div className="bg-base-200 rounded-lg p-3 text-left">
              <div className="text-xs font-medium text-base-content mb-1">To enable GitHub integration:</div>
              <div className="text-xs text-base-content/70">
                1. Include the <code className="bg-base-300 px-1 rounded">gitRepositoryUrl</code> field when registering<br/>
        ...
        {repositoryUrl && (
          <div className="mb-4">
            ...
            >
              ...
              {hasRepository ? `${config.repositoryOwner}/${config.repositoryName}` : 'View Repository'}
              {config?.autoLinked && (
                <span className="badge badge-secondary badge-sm">auto-linked</span>
              )}
            </a>
          </div>
        )}
              ...
              <div className="space-y-3">
                ...
                >
                  {triggerWorkflowMutation.isPending ? (
                    ...
                    <>
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1m4 0h1m-6 4h1m4 0h1m6-10V4a2 2 0 00-2-2H5a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V6z" />
                      </svg>
