...
import { providerApi, interactionApi, fixtureApi, deploymentApi, verificationApi } from '../utils/api'
                ...
                <div className="space-y-3">
                  ...
                  {verificationResults.length > 3 && (
                    <div className="text-center">
                      <Link to={`/verification?provider=${name}`} className="text-sm text-primary hover:underline">
              ...
              {interactionsLoading ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    ).slice(0, 3).map(([consumer, consumerInteractions]) => (
